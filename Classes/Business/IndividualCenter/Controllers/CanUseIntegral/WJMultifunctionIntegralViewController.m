//
//  WJMultifunctionIntegralViewController.m
//  jf_store
//
...
@interface WJMultifunctionIntegralViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation WJMultifunctionIntegralViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    WJCanUseIntegralCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WJMultifunctionIntegralCellIdentifier"];
    
    if (cell == nil) {
        cell = [[WJCanUseIntegralCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"WJMultifunctionIntegralCellIdentifier"];
