//
//  WJBindingApplyViewController.m
//  jf_store
//
...
@interface WJBindingApplyViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong)UITableView     *tableView;
@property(nonatomic,strong)NSArray           *listArray;
@end

@implementation WJBindingApplyViewController
