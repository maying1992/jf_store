//
//  WJIndividualFinishOrderViewController.m
//  jf_store
//
...
@interface WJIndividualFinishOrderViewController ()<UITableViewDelegate,UITableViewDataSource,APIManagerCallBackDelegate>
{
...
@implementation WJIndividualFinishOrderViewController
...
-(APIIndividualOrderManager *)orderManager
{
    ...
    _orderManager.orderStatus = OrderStatusSuccess;
