...
-(void)initBottomView
{
    ...
    NSString *totalAmountStr = [NSString stringWithFormat:@"合计: %@元%@积分",self.orderModel.totalMoney,self.orderModel.totalIntegral];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    if (section == 0) {
        ...
        if (self.orderModel.orderStatus == OrderStatusRefunding || self.orderModel.orderStatus == OrderStatusAlreadyRefund) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (section == 0) {
        ...
        receiverL.text = [NSString stringWithFormat:@"收货人：%@",self.orderModel.receiveName];
        ...
        phoneL.text = [NSString stringWithFormat:@"%@",self.orderModel.phone];
        ...
        addressL.text = [NSString stringWithFormat:@"收货地址：%@",self.orderModel.address];
        ...
        orderTimeL.text = [NSString stringWithFormat:@"提交时间：%@",self.orderModel.createTime];
        ...
        payTimeL.text = [NSString stringWithFormat:@"支付时间：%@",self.orderModel.payTime];
