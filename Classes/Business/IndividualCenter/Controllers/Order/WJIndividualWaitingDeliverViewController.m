//
//  WJIndividualWaitingDeliverViewController.m
//  jf_store
//
...
@interface WJIndividualWaitingDeliverViewController ()<UITableViewDelegate,UITableViewDataSource,APIManagerCallBackDelegate>
...
@implementation WJIndividualWaitingDeliverViewController
...
-(void)refundWithOrder:(WJOrderModel *)order
{
    ...
    applyRefundVC.orderModel = order;
...
-(APIIndividualOrderManager *)orderManager
{
    ...
    _orderManager.orderStatus = OrderStatusWaitDeliver;
