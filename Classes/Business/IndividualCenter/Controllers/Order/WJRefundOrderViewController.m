...
@interface WJRefundOrderViewController ()<UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong)NSMutableArray     *orderArray;

@end

@implementation WJRefundOrderViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    WJRefundOrderFooterView *sectionFooterView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:viewIdentfier];
    
    if(!sectionFooterView){
        
        sectionFooterView = [[WJRefundOrderFooterView alloc] initWithReuseIdentifier:viewIdentfier];
    }
    ...
    sectionFooterView.confirmRefundBlock = ^ {
        __strong typeof(self) strongSelf = weakSelf;
        //确认退款
        [strongSelf.delegate performSelector:@selector(confirmRefundWithOrder:) withObject:self.orderArray[section]];
    };
