...
@interface WJWaitingDeliverController ()<UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong)NSMutableArray     *orderArray;

@end

@implementation WJWaitingDeliverController
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    WJOrderFooterView *sectionFooterView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:viewIdentfier];
    
    if(!sectionFooterView){
        
        sectionFooterView = [[WJOrderFooterView alloc] initWithReuseIdentifier:viewIdentfier];
    }
    ...
    sectionFooterView.deliverGoodsBlock = ^{
        __strong typeof(self) strongSelf = weakSelf;
        //发货
        [strongSelf.delegate performSelector:@selector(deliverGoodsWithOrder:) withObject:self.orderArray[section]];
    };
