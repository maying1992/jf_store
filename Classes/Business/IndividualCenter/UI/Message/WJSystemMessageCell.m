...
- (void)configData:(WJSystemMessageModel *)model{
    ...
    bgView.frame           = CGRectMake(ALD(12), timeL.bottom + ALD(5), kScreenWidth - ALD(24), sizeText.height + ALD(124));
    ...
    contentL.frame         = CGRectMake(ALD(12), dateL.bottom + ALD(13), kScreenWidth - ALD(54), sizeText.height);
