...
- (BOOL)isIDCardNumber {
    NSString *value = self;
    value = [[self stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]] uppercaseString];
...
- (BOOL)isBankCardID
{
    ...
    NSString *ValidString = [value stringByReplacingOccurrencesOfString:@" " withString:@""];
...
//    int evenSum = 0;
//    
//    for (NSInteger i = ValidString.length - 1 ; i >= 0; i--)
//    {
//        int tmpDigit = [ValidString characterAtIndex:i] - '0';
//        
//        NSInteger index = ValidString.length - i;
//        
//        if ((index % 2) == 0)
//        {
//            tmpDigit *= 2;
...
- (NSString *)macCodeFormaterWithString
{
    ...
    NSMutableString * macCodeStr = [NSMutableString stringWithFormat:@"%@%@",[self substringWithRange:NSMakeRange(0, 4)],@" "];
    [macCodeStr appendString:[NSMutableString stringWithFormat:@"%@%@",[self substringWithRange:NSMakeRange(4, 4)],@" "]];
    [macCodeStr appendString:[NSMutableString stringWithFormat:@"%@%@",[self substringWithRange:NSMakeRange(8, 4)],@" "]];
    [macCodeStr appendString:[NSMutableString stringWithFormat:@"%@",[self substringWithRange:NSMakeRange(12, 6)]]];

    return (NSString *)macCodeStr;
}
