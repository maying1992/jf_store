//
//  APIServiceCenterActivateManager.m
//  jf_store
//
...
@implementation APIServiceCenterActivateManager
- (instancetype)init
{
    self = [super init];
    if (self) {
...
{
    return @{
             @"integral_id":self.integralIds ? : @"",
             @"integral_red":self.redIntegral ? : @"",
             @"integral_use":self.useIntegral ? : @""
             };
}
