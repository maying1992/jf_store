...
//    [qrFilter setValue:@"H" forKey:@"inputCorrectionLevel"];
    ...
    [qrFilter setValue:[CreatQRCodeAndBarCodeFromLeon convertErrorCorrectionLevelToString:correctionLevel]
...
+ (NSString *)convertErrorCorrectionLevelToString:(QRErrorCorrectionLevel)errorCorrectionLevel
{
